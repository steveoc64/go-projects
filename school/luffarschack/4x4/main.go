...
var player1 = [16]bool{false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false}
var player2 = [16]bool{false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false}
...
func InitGUI() {
	...
	var (
		...
		button10 = widget.NewButton("", func() {
			clicked[9] = 1
		})
		button11 = widget.NewButton("", func() {
			clicked[10] = 1
		})
		button12 = widget.NewButton("", func() {
			clicked[11] = 1
		})
		button13 = widget.NewButton("", func() {
			clicked[12] = 1
		})
		button14 = widget.NewButton("", func() {
			clicked[13] = 1
		})
		button15 = widget.NewButton("", func() {
			clicked[14] = 1
		})
		button16 = widget.NewButton("", func() {
			clicked[15] = 1
		})
	)
	...
	vbox.Append(widget.NewButton("Click to start", func() {
		...
		button8.SetIcon(nil)
		button9.SetIcon(nil)
		button10.SetIcon(nil)
		button11.SetIcon(nil)
		button12.SetIcon(nil)
		button13.SetIcon(nil)
		button14.SetIcon(nil)
		button15.SetIcon(nil)
		button16.SetIcon(nil)

		// Clear the index to make sure that we start from scratch.
		index = 0

		// Clear the board information for each player.
		player1 = [16]bool{false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false}
		player2 = [16]bool{false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false}
		...
		for won == false {
			...
			if clicked[0] == 1 {
				...
				clicked[9]++
				if index%2 == 0 {
					button10.SetIcon(circle)
					player1[9] = true
				} else {
					button10.SetIcon(cross)
					player2[9] = true
				}
				index++
			} else if clicked[10] == 1 {
				clicked[10]++
				if index%2 == 0 {
					button11.SetIcon(circle)
					player1[10] = true
				} else {
					button11.SetIcon(cross)
					player2[10] = true
				}
				index++
			} else if clicked[11] == 1 {
				clicked[11]++
				if index%2 == 0 {
					button12.SetIcon(circle)
					player1[11] = true
				} else {
					button12.SetIcon(cross)
					player2[11] = true
				}
				index++
			} else if clicked[12] == 1 {
				clicked[12]++
				if index%2 == 0 {
					button13.SetIcon(circle)
					player1[12] = true
				} else {
					button13.SetIcon(cross)
					player2[12] = true
				}
				index++
			} else if clicked[13] == 1 {
				clicked[13]++
				if index%2 == 0 {
					button14.SetIcon(circle)
					player1[13] = true
				} else {
					button14.SetIcon(cross)
					player2[13] = true
				}
				index++
			} else if clicked[14] == 1 {
				clicked[14]++
				if index%2 == 0 {
					button15.SetIcon(circle)
					player1[14] = true
				} else {
					button15.SetIcon(cross)
					player2[14] = true
				}
				index++
			} else if clicked[15] == 1 {
				clicked[15]++
				if index%2 == 0 {
					button16.SetIcon(circle)
					player1[15] = true
				} else {
					button16.SetIcon(cross)
					player2[15] = true
				}
				index++
			}
	...
	vbox.Append(fyne.NewContainerWithLayout(layout.NewGridLayout(4), button1, button2, button3, button4))
	vbox.Append(fyne.NewContainerWithLayout(layout.NewGridLayout(4), button5, button6, button7, button8))
	vbox.Append(fyne.NewContainerWithLayout(layout.NewGridLayout(4), button9, button10, button11, button12))
	vbox.Append(fyne.NewContainerWithLayout(layout.NewGridLayout(4), button13, button14, button15, button16))
...
func CheckWon(player [16]bool) bool {
